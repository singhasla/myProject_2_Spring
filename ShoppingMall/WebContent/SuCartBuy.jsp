				...
				<c:if test="${sessionScope.cart != null}">
					<c:forEach var="item" items="${cart.itemlist}">
						<tr height="80">
							...
							<td align="center"><font color="white" size="2">${item.suname}</font></td>
							<td align="center"><font color="white" size="2">${item.suprice}</font></td>
							<td align="center"><font color="white" size="2">${item.suqty}</font></td>
							<td align="center"><font color="white" size="2">${item.suprice * subean.suqty}원</font></td>
						</tr>
